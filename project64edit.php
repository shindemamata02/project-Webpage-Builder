<html>
<head>
		<link rel="stylesheet" type="text/css" href="proj64.css">
...
<body>
	<div class="wrapper">
		<div class="container">
			<div class="part1">
				<div class="menu_bar">	
					<img src="images/cake.png" class="cake_logo">
					<ul class="ul_style">
			...
			<div class="part2">
				<div class="section1">
					<img src="images/slider1.jpg" class="sec1_img">
				</div><!--end of the sec1-->
				<div class="section2">
				...
				<div class="section3">
					<div class="left_40_sec3">
						<img src="images/cake1.png" class="img_sec3">
					</div> 
